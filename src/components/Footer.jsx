      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-4">
              We craft exceptional digital experiences for developers and businesses.
              Our modern approach to web development ensures your project stands out
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="text-gray-400">
                ...
                <span>123 Developer Street</span>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            © {currentYear} CodeCraft. All rights reserved. Built with ❤️ for developers.
          </p>
        </div>
      </div>
    </footer>
